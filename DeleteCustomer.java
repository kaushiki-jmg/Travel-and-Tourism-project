...
public class DeleteCustomer extends JFrame implements ActionListener{
    ...
    DeleteCustomer(String user){
        this.username=user;
        setBounds(650,240,850,550);
        setLayout(null);
        getContentPane().setBackground(Color.WHITE);
        
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("sample/icons/delete.png"));
        Image i2=i1.getImage().getScaledInstance(300, 300, Image.SCALE_DEFAULT);
        ImageIcon i3=new ImageIcon(i2);
        JLabel l100=new JLabel(i3);
        l100.setBounds(500,100,300,300);
        add(l100);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
          ...
          try{
                ...
                c.s.executeUpdate("delete from bookDest where username='"+username+"'");

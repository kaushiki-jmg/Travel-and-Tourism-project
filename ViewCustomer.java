...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username)
    {
       ...
       JLabel l19=new JLabel();
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("sample/icons/viewall.jpg"));
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("sample/icons/viewall.jpg"));

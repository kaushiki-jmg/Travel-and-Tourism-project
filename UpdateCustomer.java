...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username)
    {
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("sample/icons/update.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String q="update customer set username='"+username+"',id='"+id+"',number='"+number+"',name='"+name+"',gender='"+radio+"',country='"+country+"',address='"+address+"',phone='"+phone+"',email='"+email+"' where username='"+uuu+"'";
        try{
            Conn c=new Conn();
            c.s.executeUpdate(q);

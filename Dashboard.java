...
public class Dashboard extends JFrame implements ActionListener{
    ...
    Dashboard(String username){
        ...
        add(p1);
         ...
         ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("sample/icons/dashhh.jpg"));
        ...
        b2.setMargin(new Insets(0,0,0,31));
        ...
        b11.setBackground(new Color(255,204,0));
        ...
        b12.setBackground(new Color(255,204,0));
        ...
        b13.setBackground(new Color(255,204,0));
        b13.setMargin(new Insets(0,0,0,145));
        b13.setFont(new Font("Times new roman",Font.PLAIN,18));
        ...
        b14.setBackground(new Color(255,204,0));
        b14.setMargin(new Insets(0,0,0,150));
        b14.setFont(new Font("Times new roman",Font.PLAIN,18));
        ...
        b16=new JButton("Book Flight");
        b16.setBackground(new Color(255,204,0));
        b16.setMargin(new Insets(0,0,0,130));
        b16.setFont(new Font("Times new roman",Font.PLAIN,18));
        b16.setForeground(Color.BLACK);
        b16.addActionListener(this);
        b16.setBounds(0,560,300,50);
        b16.addActionListener(this);
        p2.add(b16);
        
        
        b15=new JButton("About");
        b15.setBackground(new Color(255,204,0));
        b15.setMargin(new Insets(0,0,0,175));
        b15.setFont(new Font("Times new roman",Font.PLAIN,18));
        b15.setForeground(Color.BLACK);
        b15.setBounds(0,600,300,50);
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("sample/icons/dash13.jpeg"));
        ...
        JLabel l4=new JLabel("Traveloid...");
        l4.setBounds(750,230,1000,70);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b13){
            ...
            new bookdest(username).setVisible(true);

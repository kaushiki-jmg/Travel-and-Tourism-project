...
public class BookHotel2 extends JFrame implements ActionListener{
    
    Choice c1,c2,c3,c0;
    JLabel l21,l22,l23,l24,l25,l260;
    JTextField t1,t2;
    JButton b1,b2,b3,b4;
    String dest,stut, place;
    
    public BookHotel2 (String username, String city, String dd,String stateu){
        dest=city;
        place=dd;
        stut=stateu;
//        try{
...
//        
       ...
       c1=new Choice();
        try{
            Conn c=new Conn();
            ResultSet rs=c.s.executeQuery("select * from hotel where city='"+city+"'");
            while(rs.next()){
...
//        
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
           ...
           try{
               Conn c=new Conn();
               c.s.executeUpdate("insert into bookHotel values('"+l21.getText()+"','"+c1.getSelectedItem()+"','"+t1.getText()+"','"+t2.getText()+"','"+c2.getSelectedItem()+"','"+c3.getSelectedItem()+"','"+l22.getText()+"','"+l23.getText()+"','"+l24.getText()+"','"+l25.getText()+"','"+place+"','"+dest+"','"+stut+"')");
    ...
    public static void main(String args[]){
        new BookHotel2("","","","").setVisible(true);
    }
}

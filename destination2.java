...
public class destination2 extends JFrame implements Runnable{
    Thread t1;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
    JLabel[] label=new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10}; 
    JLabel caption;
    public void run(){
        String[] text=new String[]{"Varanasi Ghats","Taj Mahal","Agra Fort","India Gate","Kashmir Valley","Dargelling Hills","Ladakh Hills","Coorg Hills","Alleppey","Dudhsagar Falls"}; 
    ...
    destination2(){
        ...
        caption.setFont(new Font("Times new roman",Font.BOLD,50));
        add(caption);
        
        for(int i=0;i<=9;i++){
            image[i]=new ImageIcon(ClassLoader.getSystemResource("sample/icons/d"+Integer.toString(i+1)+".jpg"));

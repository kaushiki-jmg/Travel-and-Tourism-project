...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text=new String[]{"Tu Mariott","Mandarin Oriental","Four Seas","Radisson","Classio","Bay Club","Breeze Blows","Quick Stop","Euphoria","Alchemy"}; 
    ...
    CheckHotels(){
        ...
        for(int i=0;i<=9;i++){
            image[i]=new ImageIcon(ClassLoader.getSystemResource("sample/icons/hotel"+Integer.toString(i+1)+".jpg"));
